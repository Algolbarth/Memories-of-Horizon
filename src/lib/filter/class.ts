...
export class Filter {
    ...
    families: string[] = [];
    elements: string[] = [];
    stats: string[] = ["Aucune", "Adresse", "Affliction", "Agilité", "Charisme", "Constitution", "Endurance", "Épine", "Force", "Garde", "Intelligence", "Intensité", "Magie", "Maîtrise", "Pénétration", "Percée", "Portée", "Psychisme", "Radiation", "Régénération", "Résistance", "Vigueur", "Vitesse"];
